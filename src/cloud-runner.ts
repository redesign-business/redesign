...
function buildCompositionPrompt(hasImageContactSheets: boolean, hasHomepageScreenshot: boolean) {
  return [
    ...
    "- Choose as many purposeful components as needed to present every distinct, useful proof point in proof.md, including navigation and footer. Give each section a clear job and combine closely related proof rather than repeating or padding. Favor simple, static compositions that fit the available proof and images without layout changes.",
